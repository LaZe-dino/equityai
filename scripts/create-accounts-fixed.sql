-- EquityAI: Create Test Accounts (Fixed)
-- Run this in Supabase SQL Editor

-- Step 1: Drop the problematic trigger temporarily
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;

-- Step 2: Delete existing test accounts if they exist (clean slate)
...
-- Step 7: Verify the accounts were created
SELECT 
    u.email,
    u.email_confirmed_at IS NOT NULL as confirmed,
    u.raw_user_meta_data->>'role' as role_from_meta,
    p.full_name,
